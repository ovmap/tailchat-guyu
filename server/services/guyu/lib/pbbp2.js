...
const pbbp2 = ($root.pbbp2 = (() => {
  ...
  pbbp2.Header = (function () {
    ...
    Header.decode = function decode(reader, length) {
      ...
      if (!message.hasOwnProperty('key'))
        throw $util.ProtocolError("missing required 'key'", {
          instance: message,
        });
  ...
  pbbp2.Frame = (function () {
    ...
    Frame.encode = function encode(message, writer) {
      ...
      if (
        message.payloadEncoding != null &&
        Object.hasOwnProperty.call(message, 'payloadEncoding')
      )
        writer
          .uint32(/* id 6, wireType 2 =*/ 50)
          .string(message.payloadEncoding);
      if (
      ...
      if (
        message.LogIDNew != null &&
        Object.hasOwnProperty.call(message, 'LogIDNew')
      )
    ...
    Frame.decode = function decode(reader, length) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            message.headers.push(
              $root.pbbp2.Header.decode(reader, reader.uint32())
            );
            break;
          }
          case 6: {
      ...
      if (!message.hasOwnProperty('SeqID'))
        throw $util.ProtocolError("missing required 'SeqID'", {
          instance: message,
        });
      if (!message.hasOwnProperty('LogID'))
        throw $util.ProtocolError("missing required 'LogID'", {
          instance: message,
        });
      if (!message.hasOwnProperty('service'))
        throw $util.ProtocolError("missing required 'service'", {
          instance: message,
        });
      if (!message.hasOwnProperty('method'))
        throw $util.ProtocolError("missing required 'method'", {
          instance: message,
        });
      return message;
    };
    ...
    Frame.verify = function verify(message) {
      ...
      if (
        message.payloadEncoding != null &&
        message.hasOwnProperty('payloadEncoding')
      )
    ...
    Frame.toObject = function toObject(message, options) {
      ...
      if (message.SeqID != null && message.hasOwnProperty('SeqID'))
        if (typeof message.SeqID === 'number')
          object.SeqID =
            options.longs === String ? String(message.SeqID) : message.SeqID;
        else
          object.SeqID =
            options.longs === String
      ...
      if (message.headers && message.headers.length) {
        ...
        for (let j = 0; j < message.headers.length; ++j)
          object.headers[j] = $root.pbbp2.Header.toObject(
            message.headers[j],
            options
          );
      }
